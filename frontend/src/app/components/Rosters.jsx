  ...
  return (
    <>
      ...
      <div className="flex flex-grow flex-row justify-between">
        <div
          key={userRoster.roster_id || idx}
          className="border border-gray-300 rounded-xl p-4 shadow-sm hover:shadow-md transition"
        >
          <h2 className="text-lg font-bold mb-2">
            {userRoster.username || userRoster.owner_id}
          </h2>

          <div className="text-sm text-gray-700 mb-2 font-medium">
            Record: {userRoster.settings.wins} - {userRoster.settings.losses}
            {userRoster.settings.ties !== 1 && ` - ${userRoster.settings.ties}`}
          </div>
          ...
          <div className="mb-3">
            ...
            <ul className="list-disc list-inside ml-4">
              {!userRoster.starters || userRoster.starters.length === 0 ? (
                ...
                userRoster.starters.map(({ id, data }, index) =>
                  data ? (
                    <li key={id || index}>
          ...
          <div className="mb-3">
            {userRoster.players && userRoster.players.length > 0 && (
              <strong>Bench:</strong>
            )}
            <ul className="list-disc list-inside ml-4">
              {userRoster.players
        ...
        >
          ...
          <div className="mb-3">
            {selectedRoster?.starters &&
              selectedRoster?.starters.length > 0 && <strong>Starters:</strong>}
